    ...
    return (
        <Dialog.Root open={open}>
            <Dialog.Portal>
                ...
                <Dialog.Content className=" shadow-lg fixed left-1/2 top-1/2 max-h-[85vh] w-[90vw] max-w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-md bg-gray1 p-[25px] shadow-[var(--shadow-6)] focus:outline-none data-[state=open]:animate-contentShow">
