...
import {ExitIcon, HamburgerMenuIcon, Link2Icon, PersonIcon} from "@radix-ui/react-icons";
...
export default ({isUser}: { isUser: boolean }) => {
    ...
    return (
        <div>
            <SpaceUserExitErrorDialog alertState={errorState}
                                      closeWindow={() => setErrorState(false)}></SpaceUserExitErrorDialog>
            <SpaceExitDialog leave={leaveSpace} alertState={alertState}
                             closeWindow={() => setAlertState(false)}></SpaceExitDialog>
            <AdminChangeDialog open={changeAdminState}
                               closeWindow={() => setChangeAdminState(false)}></AdminChangeDialog>
